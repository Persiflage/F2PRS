	...
	<div class="tabs">
	    <ul class="tab-links">
	        ...
	        <li><a href="#tab4"><img src="assets/images/icons/strength.png" class="tab_icon" /></a></li>
   	     	...
   	     	<li><a href="#tab11"><img src="assets/images/icons/fletching.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab12"><img src="assets/images/icons/fishing.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab13"><img src="assets/images/icons/firemaking.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab14"><img src="assets/images/icons/crafting.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab15"><img src="assets/images/icons/smithing.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab16"><img src="assets/images/icons/mining.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab17"><img src="assets/images/icons/runecrafting.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab18"><img src="assets/images/icons/dungeoneering.png" class="tab_icon" /></a></li>
   	     	<li><a href="#tab19"><img src="assets/images/icons/ehp.png" class="tab_icon" /></a></li>
   	 	</ul>
		...
		<?php
			...
			foreach($order as $key => $value) { // LOOP THROUGH SKILLS
				...
				$data = $link->query("SELECT rsn, $value FROM week ORDER BY $value desc LIMIT 10");
				echo "<div class='record_column'>\n";
				echo "<h1>Week</h1>\n";
				...
				$data = $link->query("SELECT rsn, $value FROM month ORDER BY $value desc LIMIT 10");
				echo "<div class='record_column'>\n";
				echo "<h1>Month</h1>\n";
				echo "<table class='record_table'>";
				while($gains = $data->fetch_array(MYSQLI_ASSOC)) {
